...
env:
  ...
  - name: APPLICATION_AUTHENTICATION_NOTIFY_PRE_DISABLE_ENABLED
    value: {{ .Values.env.APPLICATION_AUTHENTICATION_NOTIFY_PRE_DISABLE_ENABLED | quote }}
  ...
  - name: DELIUS_ROLES_MAPPINGS_LHDCBT001
    value: "ROLE_LICENCE_RO,ROLE_LICENCE_RO_READ_ONLY,ROLE_GLOBAL_SEARCH"
