...
env:
  ...
  - name: APPLICATION_AUTHENTICATION_MFA_ROLES
    value: "ROLE_MFA,ROLE_PECS_COURT,ROLE_PECS_SUPPLIER,ROLE_PF_STD_PRISON,ROLE_PF_STD_PRISON_RO,ROLE_PF_STD_PROBATION,ROLE_PF_STD_PROBATION_RO,ROLE_PF_POLICE,ROLE_PF_HQ,ROLE_PPM_ANALYST"
