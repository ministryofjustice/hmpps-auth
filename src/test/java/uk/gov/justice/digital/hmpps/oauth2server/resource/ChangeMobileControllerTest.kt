...
class ChangeMobileControllerTest {
  ...
  private val controller = ChangeMobileController()
  ...
  inner class NewMobileRequest {
    ...
    fun newPasswordRequest() {
      ...
      val view = controller.newMobileRequest()
      assertThat(view.viewName).isEqualTo("changeMobile")
    }
  }
  ...
  private fun setupGetToken() {
    whenever(tokenService.getToken(any(), anyString())).thenReturn(Optional.of(User.of("someuser").createToken(UserToken.TokenType.MOBILE)))
  }
}
