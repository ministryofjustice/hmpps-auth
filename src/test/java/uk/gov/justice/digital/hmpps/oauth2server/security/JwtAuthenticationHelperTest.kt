...
class JwtAuthenticationHelperTest {
  ...
  fun testReadAndWriteWithoutAuthorities() {
    ...
    assertThat(auth.get().principal).extracting("username", "name", "authSource", "userId").containsExactly("user", "name", "none", "user id")
