...
enum UserAccount {
    ...
    DELIUS_USER('DELIUS'),
    DELIUS_USER_EMAIL('DELIUS_EMAIL'),
    DELIUS_DISABLED('DELIUS_ERROR_DISABLED'),
    DELIUS_LOCKED('DELIUS_ERROR_LOCKED'),
    DELIUS_PASSWORD_RESET('DELIUS_PASSWORD_RESET'),
    DELIUS_TIMEOUT('DELIUS_ERROR_TIMEOUT'),
    DELIUS_SERVER_ERROR('DELIUS_ERROR_SERVER');
