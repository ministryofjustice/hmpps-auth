...
CREATE USER ITAG_USER_ADM password 'password123456';
CREATE USER CA_USER password 'password123456';
CREATE USER RO_USER password 'password123456';
CREATE USER DM_USER password 'password123456';
CREATE USER NOMIS_BATCHLOAD password 'password123456';

CREATE USER LOCKED_USER password 'password123456';
CREATE USER EXPIRED_USER password 'password123456';
