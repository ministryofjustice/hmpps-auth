...
CREATE USER IF NOT EXISTS ARTEMIS_PRISON_USER password 'password123456';
...
VALUES ('ITAG_USER', 'GENERAL', 1, 'MDI'),
  ...
  ('ARTEMIS_PRISON_USER', 'GENERAL', 38, 'BEL');
...
VALUES ('ITAG_USER', 'OPEN', 'TAG_GENERAL'),
  ...
  ('NOMIS_LOCKED_AUTH_DISABLED', 'EXPIRED_LOCKED', 'TAG_GENERAL'),
  ('PPM_ANALYST_USER', 'OPEN', 'TAG_GENERAL'),
  ('ARTEMIS_PRISON_USER', 'OPEN', 'TAG_GENERAL');
...
VALUES ('ITAG_USER', '{bcrypt}$2a$10$9rVgms..dZ3gnPSt4JWPA.Oan4MrDHvcx1c.HuYqeMD5rVFmf0C3G'),
  ...
  ('ARTEMIS_PRISON_USER', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy');
...
INSERT INTO USER_ACCESSIBLE_CASELOADS (CASELOAD_ID, USERNAME, START_DATE) VALUES ('NWEB', 'ARTEMIS_PRISON_USER', now());
