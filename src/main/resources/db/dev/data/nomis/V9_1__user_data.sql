...
VALUES ('ITAG_USER', 'GENERAL', 1, 'MDI'),
  ...
  ('RO_USER_READONLY_TEST', 'GENERAL', 48, 'BEL'),
  ('PPUD_USER', 'GENERAL', 49, 'LEI'),
  ('CALCULATE_RELEASE_DATES_LOCAL', 'GENERAL', 51, 'BEL'),
  ('CVL_OMU_LOCAL', 'GENERAL', 52, 'BEL');
...
VALUES (1, 'OMIC_ADMIN', 'Omic Administrator', 1, 'APP', 'GENERAL'),
  ...
  (43, 'LICENCE_RO_READONLY', 'Licence RO Read Only', 101, 'APP', 'GENERAL'),
  (44, 'MANAGE_RECALLS', 'PPUD Manage Recalls', 99, 'APP', 'ADMIN');
