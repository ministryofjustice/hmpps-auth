...
CREATE USER IF NOT EXISTS RCTL_USER1 password 'password123456';
CREATE USER IF NOT EXISTS PPL_RCTL_USER1 password 'password123456';
...
INSERT INTO STAFF_MEMBERS (STAFF_ID, FIRST_NAME, LAST_NAME, STATUS)
VALUES (27, 'Pathfinder', 'RctlUser1', 'ACTIVE');
INSERT INTO STAFF_MEMBERS (STAFF_ID, FIRST_NAME, LAST_NAME, STATUS)
VALUES (28, 'Pathfinder', 'PplRctlUser1', 'ACTIVE');
INSERT INTO STAFF_MEMBERS (STAFF_ID, FIRST_NAME, LAST_NAME, STATUS)
VALUES (29, 'Pom', 'User', 'ACTIVE');
INSERT INTO STAFF_MEMBERS (STAFF_ID, FIRST_NAME, LAST_NAME, STATUS)
VALUES (30, 'Use of Force', 'Coordinator', 'ACTIVE');
...
VALUES ('ITAG_USER', 'GENERAL', 1, 'MDI'),
  ...
  ('RCTL_USER1', 'GENERAL', 27, 'BEL'),
  ('PPL_RCTL_USER1', 'GENERAL', 28, 'BEL'),
  ('POM_USER', 'GENERAL', 29, 'BEL'),
  ('UOF_COORDINATOR_USER', 'GENERAL', 30, 'BEL');
...
VALUES ('ITAG_USER', 'OPEN', 'TAG_GENERAL'),
  ...
  ('RCTL_USER1', 'OPEN', 'TAG_GENERAL'),
  ('PPL_RCTL_USER1', 'OPEN', 'TAG_GENERAL'),
...
VALUES ('ITAG_USER', '{bcrypt}$2a$10$9rVgms..dZ3gnPSt4JWPA.Oan4MrDHvcx1c.HuYqeMD5rVFmf0C3G'),
  ...
  ('RCTL_USER1', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy'),
  ('PPL_RCTL_USER1', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy'),
...
INSERT INTO USER_ACCESSIBLE_CASELOADS (CASELOAD_ID, USERNAME, START_DATE) VALUES ('NWEB', 'RCTL_USER1', now());
INSERT INTO USER_ACCESSIBLE_CASELOADS (CASELOAD_ID, USERNAME, START_DATE) VALUES ('NWEB', 'PPL_RCTL_USER1', now());
...
VALUES (1, 'OMIC_ADMIN', 'Omic Administrator', 1, 'APP', 'GENERAL'),
  ...
  (27, 'PATHFINDER_RCTL', 'Regional Terrorism Lead', 99, 'APP', 'GENERAL'),
  (29, 'POM', 'Prisoner Offender Manager', 99, 'APP', 'GENERAL'),
  (30, 'USE_OF_FORCE_COORDINATOR', 'Use of force coordinator', 99, 'APP', 'ADMIN');
...
VALUES (-1, 'MDI', 'ITAG_USER'),
  ...
  (27, 'NWEB', 'RCTL_USER1'),
  (24, 'NWEB', 'PPL_RCTL_USER1'),
  (27, 'NWEB', 'PPL_RCTL_USER1'),
  (29, 'NWEB', 'POM_USER'),
  (30, 'NWEB', 'UOF_COORDINATOR_USER');
