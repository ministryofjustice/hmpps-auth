...
INSERT INTO user_contact (user_id, type, value, verified) SELECT user_id, 'SECONDARY_EMAIL', 'john@smith.com', 0 FROM users where username = 'AUTH_SECOND_EMAIL_VERIFY';
