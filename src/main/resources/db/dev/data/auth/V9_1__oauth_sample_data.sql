...
VALUES ('omicuser','1200',null,'SYSTEM_READ_ONLY','password,authorization_code,refresh_token','read','$2a$10$EiAoV/3ZSHl4KsVAkYZmH.pfZ6tLcK2vlvJTBgQBML3p3LrcPjaCi',null,null,'read','http://localhost:3000/login'),
       ...
       ('whereabouts-api-client','3600',null,'ROLE_SYSTEM_USER,ROLE_PAY,ROLE_CASE_NOTE_ADMIN','client_credentials',null,'$2a$10$lBwbziQlLfiCnn8Kj1PfMujEcLdsJYlYSNJvBRO638gCYTS9yN0xm',null,null,'read,write',null);


INSERT INTO oauth_service (code, name, description, authorised_roles, url, enabled)
VALUES ('NOMIS','New NOMIS', null, null, 'http://localhost:3000', 'true'),
       ('HDC','Home Detention Curfew', null, 'ROLE_LICENCE_CA,ROLE_LICENCE_RO,ROLE_LICENCE_DM', 'http://localhost:3003', 'true'),
