...
class ExistingPasswordController(
  ...
  fun existingPasswordRequestEmail(authentication: Authentication): ModelAndView =
    createModelAndViewWithUsername(authentication).addObject("type", "email")

  @GetMapping("/existing-password")
  fun existingPasswordRequestPassword(authentication: Authentication): ModelAndView =
    createModelAndViewWithUsername(authentication).addObject("type", "password")
  ...
  fun existingPassword(
    ...
    return try {
      ...
      telemetryClient.trackEvent(
        "ExistingPasswordAuthenticateFailure",
