...
public class InitialPasswordController extends AbstractPasswordController {
    ...
    public InitialPasswordController(final ResetPasswordService resetPasswordService,
        ...
        super(resetPasswordService, tokenService, userService, telemetryClient, "initialPassword", "setPassword", passwordBlacklist);
        this.tokenService = tokenService;
    }

    @GetMapping("/initial-password")
    public ModelAndView initialPasswordConfirm(@RequestParam final String token) {
