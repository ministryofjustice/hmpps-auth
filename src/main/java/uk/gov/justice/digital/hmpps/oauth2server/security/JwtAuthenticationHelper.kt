...
public class JwtAuthenticationHelper {
    ...
    String createJwtWithIdFromOidcAuthentication(final OAuth2AuthenticationToken authentication, final String jwtId) {
        ...
        return Jwts.builder()
                .setId(jwtId)
                .setSubject(username)
                .addClaims(Map.of("authorities", authoritiesAsString, "name", userDetails.getFullName(), "auth_source", AuthSource.azuread.getSource(), "user_id", userDetails.getPreferredUsername().toLowerCase()))
