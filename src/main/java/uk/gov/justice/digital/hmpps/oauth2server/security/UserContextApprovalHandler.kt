...
class UserContextApprovalHandler(private val userContextService: UserContextService) : TokenStoreUserApprovalHandler() {
  override fun checkForPreApproval(authorizationRequest: AuthorizationRequest, userAuthentication: Authentication):
  ...
  override fun getUserApprovalRequest(authorizationRequest: AuthorizationRequest, userAuthentication: Authentication):
